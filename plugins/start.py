...
#=====================================================================================##
# Don't Remove Credit @BotifyX_Pro_Botz, @ITS_shun_x
# Ask Doubt on telegram @BotifyX_Pro_Botz
            ...
            if not await is_sub(client, user_id, chat_id):
                try:
                    ...
                    return #await temp.edit(
                        #f"<b><i>! Eʀʀᴏʀ, Cᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴏ sᴏʟᴠᴇ ᴛʜᴇ ɪssᴜᴇs @ITS_shun_x</i></b>\n"
...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "close":
        ...
        await query.edit_message_media(
            InputMediaPhoto("https://ibb.co/C5q41g1C", 
                            CHANNELS_TXT
            ),
            reply_markup=InlineKeyboardMarkup([
